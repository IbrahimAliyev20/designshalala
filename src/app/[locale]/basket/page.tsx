                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-col items-start gap-3 md:flex-row md:items-center md:justify-between">
                        ...
                        <div className="flex items-center gap-2 md:gap-3 bg-gray-100 rounded-full px-3 py-1.5 md:px-4 md:py-2 self-end md:self-auto">
                          <button
          ...
          <div className="md:col-span-1">
            <div className="bg-white rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100 md:sticky md:top-28">
              ...
              <button
                ...
                className="w-full bg-black text-white py-3 md:py-4 rounded-full font-semibold hover:bg-gray-800 transition-colors flex items-center justify-center gap-2 group cursor-pointer"
