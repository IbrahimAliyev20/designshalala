...
export default function BasketPage() {
  ...
  const handleCheckout = () => {
    ...
    // === iPhone HƏLLİ ===
    // 1. Gizli bir link yaradırıq
    const link = document.createElement("a");
    link.href = whatsappURL;
    link.target = "_blank"; // Safari-nin bəzi versiyaları üçün bu, mütləqdir

    // 2. Linki sənədə əlavə edirik (bəzi brauzerlər tələb edir)
    document.body.appendChild(link);

    // 3. Həmin linkə "klikləyirik"
    link.click();

    // 4. Linki dərhal sənəddən silirik (təmizlik)
