...
export default function AboutPage() {
  return (
    <div className="bg-white text-gray-900">
      ...
      {/* === 2. BİZİM HEKAYƏMİZ (MƏTN DƏYİŞDİRİLDİ) === */}
      <section className="py-16 md:py-24">
        <Container>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
            
    
            {/* DƏYİŞİLMİŞ MƏTN BLOKU */}
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div className="flex flex-col items-center p-4">
              ...
              <h3 className="text-xl font-semibold mb-2">1. Fərdi Dizayn</h3>
            ...
            <div className="flex flex-col items-center p-4">
              ...
              <h3 className="text-xl font-semibold mb-2">2. Sevgi ilə Hazırlıq</h3>
              <p className="text-gray-600">
            ...
            <div className="flex flex-col items-center p-4">
              ...
              <h3 className="text-xl font-semibold mb-2">3. Zərif Təqdimat</h3>
              <p className="text-gray-600">
