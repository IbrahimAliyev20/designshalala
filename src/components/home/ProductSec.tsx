    ...
    <section className="py-16 sm:py-24 bg-white">
      <div className="container mx-auto px-4">
        <Tabs defaultValue="Hamısı" className="w-full">
          {/* DƏYİŞİKLİK: Mobildə w-full, overflow-x-auto və daha az gap. Desktopda md:w-[60%] və md:gap-8 */}
          <TabsList className="w-full md:w-[60%] flex justify-start items-center gap-4 md:gap-8 bg-transparent border-b border-gray-200 rounded-none p-0 h-auto mb-12 overflow-x-auto">
            <TabsTrigger
              value="Hamısı"
              // DƏYİŞİKLİK: text-sm md:text-base və whitespace-nowrap əlavə edildi
          ...
          {/* Grid hissəsi onsuz da responsiv idi, dəyişiklik edilmədi */}
